...
(function ($)
{
        ...
        $.fn.wysiwyg.controls = {
                ...
                insertUnorderedList: {
                        visible: true,
                        tags: ['ul'],
                        tooltip: 'Vložit nečíslovaný seznam'
                },
                insertHorizontalRule: {
                        visible: true,
                        tags: ['hr'],
                        tooltip: 'Vložit horizontální čáru'
                },
                createLink: {
                        groupIndex: 6,
                        visible: true,
                ...
                insertTable: {
                        ...
                        exec: function ()
                        {
                                ...
                                else
                                {
                                    ...
                                    {
                                            var colCount = prompt('Počet sloupců', '3');
                                            var rowCount = prompt('Počet řádků', '3');
                ...
                increaseFontSize: {
                        ...
                        tags: ['big'],
                        tooltip: 'Zvětšit velikost písma'
                },
                decreaseFontSize: {
                        visible: false && !($.browser.msie),
                        tags: ['small'],
                        tooltip: 'Zmenšit velikost písma'
                },
                removeFormat: {
                         visible: true,
                         exec: function ()
                ...
                html: {
                        ...
                        exec: function ()
                        {
                         ...
                         tooltip: 'Zobrazit zdrojový kód (HTML)'
                },
                rtl: {
                         visible : false,
                         exec    : function()
        ...
        $.extend(Wysiwyg.prototype, {
                ...
                initFrame: function ()
                {
                        ...
                        {
                                this.setContent('<p>Stránka se připravuje</p>');
                        }
