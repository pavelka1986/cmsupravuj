<?php //netteCache[01]000236a:2:{s:4:"time";s:21:"0.59276600 1307705127";s:9:"callbacks";a:1:{i:0;a:3:{i:0;a:2:{i:0;s:5:"Cache";i:1;s:9:"checkFile";}i:1;s:81:"/home/www/mysoftware.cz/www/mysoftware.cz/app/FrontModule/templates/@layout.phtml";i:2;i:1307705122;}}}?><?php
// file …/FrontModule/templates/@layout.phtml
//

$_cb = LatteMacros::initRuntime($template, NULL, '795b01c5bb'); unset($_extends);


//
// block title
//
if (!function_exists($_cb->blocks['title'][] = '_cbb45e274399e_title')) { function _cbb45e274399e_title($_cb) { extract(func_get_arg(1))
;
}}
...
<script type="text/javascript">
  ...
  _gaq.push(['_setAccount', 'UA-1199040-10']);
  ...
  <body>
    ...
    <div id="container_info">
      ...
      <div id="info">
        ...
        <div>
          ...
          <img src="<?php echo TemplateHelpers::escapeHtml($basePath) ?>/img/web/info/kexi.png" alt="Snadná dostupnost" />Snadná dostupnost

        </div>

        <div>

          <img src="<?php echo TemplateHelpers::escapeHtml($basePath) ?>/img/web/info/document_encrypt.png" alt="Vysoké zabezpečení" /> Vysoké zabezpečení

        </div>

        <div>

          <img src="<?php echo TemplateHelpers::escapeHtml($basePath) ?>/img/web/info/book2.png" alt="Rychlost a jednoduchost" /> Rychlost a jednoduchost

        </div>

        <div>

          <img src="<?php echo TemplateHelpers::escapeHtml($basePath) ?>/img/web/info/games_hint.png" alt="Rychlost a jednoduchost" /> Rychlost a jednoduchost

        </div>

        <div>

          <img src="<?php echo TemplateHelpers::escapeHtml($basePath) ?>/img/web/info/apply.png" alt="Účetnictví zdarma" /> Účetnictví zdarma
    ...
    <div id="container_paticka">
      ...
      <div id="paticka">        (c) 2010 MySoftware.cz je účetní aplikace určená pro živnostníky, malé a velké firmy  |
        ...
        <a href="<?php echo TemplateHelpers::escapeHtml($control->link(":Admin:Default:")) ?>">Administrace</a> | <a href="http://davidpavelka.ledec-nad-sazavou.cz">Vytvořil</a>
