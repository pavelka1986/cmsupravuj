<?php //netteCache[01]000225a:2:{s:4:"time";s:21:"0.11724500 1287477979";s:9:"callbacks";a:1:{i:0;a:3:{i:0;a:2:{i:0;s:5:"Cache";i:1;s:9:"checkFile";}i:1;s:70:"/var/www/3dprojekce.fs.cvut.cz/app/FrontModule/templates/@layout.phtml";i:2;i:1287049586;}}}?><?php
// file …/FrontModule/templates/@layout.phtml
//

$_cb = LatteMacros::initRuntime($template, NULL, '7e4d443f0a'); unset($_extends);


//
// block title
//
if (!function_exists($_cb->blocks['title'][] = '_cbbbcf4101b59_title')) { function _cbbbcf4101b59_title($_cb) { extract(func_get_arg(1))
;
}}
...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">  
  <head>    
    ...
    <title><?php if (!$_cb->extends) { call_user_func(reset($_cb->blocks['title']), $_cb, get_defined_vars()); } ?> | Web     
    </title>    
