<?php //netteCache[01]000263a:2:{s:4:"time";s:21:"0.84818200 1289849433";s:9:"callbacks";a:1:{i:0;a:3:{i:0;a:2:{i:0;s:5:"Cache";i:1;s:9:"checkFile";}i:1;s:107:"C:\Program Files\VertrigoServ\www\www\3dprojekce.fs.cvut.cz/app/AdminModule/templates/Default.default.phtml";i:2;i:1289848425;}}}?><?php
// file …/AdminModule/templates/Default.default.phtml
//

$_cb = LatteMacros::initRuntime($template, NULL, '2c9343bd5f'); unset($_extends);


//
// block title
//
if (!function_exists($_cb->blocks['title'][] = '_cbba0479c87d9_title')) { function _cbba0479c87d9_title($_cb) { extract(func_get_arg(1))
...
// block content
//
if (!function_exists($_cb->blocks['content'][] = '_cbb2b36a0c909_content')) { function _cbb2b36a0c909_content($_cb) { extract(func_get_arg(1))
