<?php //netteCache[01]000240a:2:{s:4:"time";s:21:"0.45066100 1290768740";s:9:"callbacks";a:1:{i:0;a:3:{i:0;a:2:{i:0;s:5:"Cache";i:1;s:9:"checkFile";}i:1;s:85:"C:\VertrigoServ\www\www\www.mysoftware.cz/app/FrontModule/templates/Web/default.phtml";i:2;i:1290524958;}}}?><?php
// file …/FrontModule/templates/Web/default.phtml
//

$_cb = LatteMacros::initRuntime($template, NULL, 'afaaeceb14'); unset($_extends);


//
// block title
//
if (!function_exists($_cb->blocks['title'][] = '_cbbc0547eb98d_title')) { function _cbbc0547eb98d_title($_cb) { extract(func_get_arg(1))
...
// block content
//
if (!function_exists($_cb->blocks['content'][] = '_cbbb3a6bd4b6a_content')) { function _cbbb3a6bd4b6a_content($_cb) { extract(func_get_arg(1))
