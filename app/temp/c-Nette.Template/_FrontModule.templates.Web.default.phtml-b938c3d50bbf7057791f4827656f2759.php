<?php //netteCache[01]000229a:2:{s:4:"time";s:21:"0.11069500 1287477979";s:9:"callbacks";a:1:{i:0;a:3:{i:0;a:2:{i:0;s:5:"Cache";i:1;s:9:"checkFile";}i:1;s:74:"/var/www/3dprojekce.fs.cvut.cz/app/FrontModule/templates/Web/default.phtml";i:2;i:1287041982;}}}?><?php
// file …/FrontModule/templates/Web/default.phtml
//

$_cb = LatteMacros::initRuntime($template, NULL, 'ddcaa4ae1a'); unset($_extends);


//
// block title
//
if (!function_exists($_cb->blocks['title'][] = '_cbbef20588703_title')) { function _cbbef20588703_title($_cb) { extract(func_get_arg(1))
...
// block content
//
if (!function_exists($_cb->blocks['content'][] = '_cbbffa367bd63_content')) { function _cbbffa367bd63_content($_cb) { extract(func_get_arg(1))
