<?php //netteCache[01]000230a:2:{s:4:"time";s:21:"0.34935000 1287559997";s:9:"callbacks";a:1:{i:0;a:3:{i:0;a:2:{i:0;s:5:"Cache";i:1;s:9:"checkFile";}i:1;s:75:"/var/www/3dprojekce.fs.cvut.cz/app/AdminModule/templates/Auth.@layout.phtml";i:2;i:1287037971;}}}?><?php
// file …/AdminModule/templates/Auth.@layout.phtml
//

$_cb = LatteMacros::initRuntime($template, NULL, '495de26edb'); unset($_extends);


//
// block title
//
if (!function_exists($_cb->blocks['title'][] = '_cbb0f123686e4_title')) { function _cbb0f123686e4_title($_cb) { extract(func_get_arg(1))
...
<body>
  ...
  <div id="top"></div>
   ...
   <div id="dotted"><h1>Přihlásit se</h1>
