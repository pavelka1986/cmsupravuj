<?php //netteCache[01]000254a:2:{s:4:"time";s:21:"0.97404900 1290524970";s:9:"callbacks";a:1:{i:0;a:3:{i:0;a:2:{i:0;s:5:"Cache";i:1;s:9:"checkFile";}i:1;s:99:"C:\Program Files\VertrigoServ\www\www\www.mysoftware.cz/app/FrontModule/templates/Web/default.phtml";i:2;i:1290524957;}}}?><?php
// file …/FrontModule/templates/Web/default.phtml
//

$_cb = LatteMacros::initRuntime($template, NULL, '77e597e7bd'); unset($_extends);


//
// block title
//
if (!function_exists($_cb->blocks['title'][] = '_cbb5d2676415b_title')) { function _cbb5d2676415b_title($_cb) { extract(func_get_arg(1))
...
// block content
//
if (!function_exists($_cb->blocks['content'][] = '_cbb9e343910f9_content')) { function _cbb9e343910f9_content($_cb) { extract(func_get_arg(1))
