<?php //netteCache[01]000236a:2:{s:4:"time";s:21:"0.96026400 1290964779";s:9:"callbacks";a:1:{i:0;a:3:{i:0;a:2:{i:0;s:5:"Cache";i:1;s:9:"checkFile";}i:1;s:81:"/home/www/mysoftware.cz/www/mysoftware.cz/app/AdminModule/templates/@layout.phtml";i:2;i:1290963078;}}}?><?php
// file …/AdminModule/templates/@layout.phtml
//

$_cb = LatteMacros::initRuntime($template, NULL, '37c1bc47ba'); unset($_extends);


//
// block title
//
if (!function_exists($_cb->blocks['title'][] = '_cbb3ab1c8ca0a_title')) { function _cbb3ab1c8ca0a_title($_cb) { extract(func_get_arg(1))
...
<script type="text/javascript" src="<?php echo TemplateHelpers::escapeHtml($basePath) ?>/js/fancybox/jquery.fancybox-1.3.4.pack.js"></script>
<script type="text/javascript" src="<?php echo TemplateHelpers::escapeHtml($basePath) ?>/js/jfancybox/jquery.mousewheel-3.0.4.pack.js"></script>
    <link rel="stylesheet" type="text/css" href="<?php echo TemplateHelpers::escapeHtml($basePath) ?>/js/fancybox/jquery.fancybox-1.3.4.css" media="screen" />
    <link rel="stylesheet" href="<?php echo TemplateHelpers::escapeHtml($basePath) ?>/js/jwysiwyg/jquery.wysiwyg.css" type="text/css" />
<script type="text/javascript" src="<?php echo TemplateHelpers::escapeHtml($basePath) ?>/js/jwysiwyg/jquery.wysiwyg.js"></script>
<script type="text/javascript" src="<?php echo TemplateHelpers::escapeHtml($basePath) ?>/js/datapicker/jquery-ui-1.8.6.custom.min.js"></script>
<script type="text/javascript" src="<?php echo TemplateHelpers::escapeHtml($basePath) ?>/js/datapicker/jquery.ui.datepicker-cs.js"></script>
<link rel="stylesheet" type="text/css" href="<?php echo TemplateHelpers::escapeHtml($basePath) ?>/js/smoothness/jquery-ui-1.8.6.custom.css" media="screen" />
<script type="text/javascript" src="<?php echo TemplateHelpers::escapeHtml($basePath) ?>/js/adds.js"></script>
  </head>
  <body>
    <div id="container">
      <div id="top">
